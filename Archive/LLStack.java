/**
 * Group 5: AppleSoft
 * Masa Nakura, Aaron Xie, Athena Kim
 * Period 7 Special Topics in Computer Science
...
public class LLStack {
   ...
   private class Node  {
      ...
      // @param newData - Object stored in the node
      // @param nextLink - next Node in the list
   ...
   // @param itemData - the data stored in the new head of this stack
   ...
   // returns true if there is match for the given object
   // and returns false otherwise. 
   public boolean contains(Object item) {
      // to do
      return this.findData(item) != null;
   }
      
   // Finds the first node containing the given target item, and returns a
   ...
   // prints out all objects stored in the node from the head to the tail 
   ...
   // returns all the node values represented by a string 
   ...
   // removes every objects in the stack
   public void clear( ) {
      // to do
      this.head = null;
   }
